...
export default function Heromain(){
    ...
    <div className="Heromain-container text-white h-screen bg-h grid md:grid-cols-2 gap-2 p-2 m-4">
        <div className="grid grid-cols-2 gap-2 p-2">
            <div className="smmaingrid"><h1 className="text-4xl font-bold">10+</h1><p className="text-sm capitalize tracking-widest text-gray-400">completed projects</p></div>
        ...
        <div className="flex flex-col items-start justify-center bg-green-300 rounded-2xl">
